...
// Render helper for budget cards
function renderBudgetContent($userId, $month, $year) {
            ...
            <div style="display:flex; gap:16px; align-items:center; flex-wrap:wrap;">
                <div style="flex:1; min-width:200px;">
                    ...
                    <div style="display:flex; gap:8px; align-items:center;">
                        ...
                        <button type="submit" name="save_monthly_budget" class="btn-submit-quick">Lưu</button>
                    </div>
                </div>
    ...
    <div class="card filter-result-card">
        <form action="?template=user&action=budget" method="POST">
            ...
            <div class="filter-toolbar">
                ...
                <button type="submit" name="save_budget" class="btn-submit-quick">Lưu danh mục</button>
            </div>
...
if (isset($_GET['ajax']) && $_GET['ajax'] === '1') {
    ...
    ob_start();
    renderBudgetContent($userId, $month, $year);
    $html = ob_get_clean();
...
<div class="app-container">
    ...
    <main class="main-content">
        ...
        <div class="page-content" style="padding-top: 20px;">
            ...
            <div class="card" style="margin-bottom: 20px; padding: 20px;">
                <form action="" method="GET" style="display: flex; gap: 10px; align-items: flex-end;">
                    ...
                    <div>
                        ...
                        <select name="month" style="padding:8px 10px; border:1px solid #ddd; border-radius:4px; font-size:14px; width:100px; background:#fff;" onchange="loadBudget()">
                            <?php for ($m = 1; $m <= 12; $m++): ?>
                    ...
                    <div>
                        ...
                        <select name="year" style="padding:8px 10px; border:1px solid #ddd; border-radius:4px; font-size:14px; width:100px; background:#fff;" onchange="loadBudget()">
            ...
            <div id="budgetContent"><?php renderBudgetContent($userId, $month, $year); ?></div>
        </div>
    </main>
</div>

<?php layout("footer", ["js" => ["pages/sidebar", "pages/budget"]]); ?>

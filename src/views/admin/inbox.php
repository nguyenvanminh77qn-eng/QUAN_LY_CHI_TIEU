...
$adminId  = (int)getSession('id');
$username = getSession('username');
$view     = 'inbox';
?>
<?php layout("header", [
    "title" => "Hộp thư Admin — " . htmlspecialchars($username ?? ''),
    "css"   => ["layout/sidebar", "pages/admin/theme", "pages/user/feedback"]
]); ?>
        ...
        <div class="page-content" style="padding:0;display:flex;flex-direction:column;flex:1;min-height:0;">
            <div class="fb-page">
                ...
                <div class="fb-page-header">
                    ...
                    <span class="fb-page-title">Hỗ trợ người dùng</span>
                ...
                <div class="fb-page-body">
                    ...
                    <div class="fb-page-sidebar">
                        <div class="fb-search-bar">
                            ...
                            <input type="search" class="fb-search-input" placeholder="Tìm người dùng..." aria-label="Tìm kiếm cuộc trò chuyện">
                        </div>
                        <div class="fb-page-threads" id="fb-page-threads" role="list" aria-label="Danh sách phản hồi"></div>
                    </div>
                    ...
                    <div class="fb-page-main">
                        ...
                        <div class="fb-page-empty" role="status">
                            ...
                            <div class="fb-page-empty-title">Chọn một cuộc trò chuyện</div>
                            <div class="fb-page-empty-desc">Hoặc nhấn nút bút chì để gửi tin nhắn chủ động tới người dùng.</div>
                        </div>
                        ...
                        <div class="fb-compose" id="fb-page-compose" aria-label="Soạn tin nhắn mới">
                            ...
                            <div class="fb-compose-receiver">
                                <label for="compose-user-select">Gửi đến User</label>
                                <select class="fb-select-user" id="compose-user-select" aria-label="Chọn User nhận tin nhắn"></select>
                            </div>
                            <div class="fb-compose-field">
                                ...
                                <textarea class="fb-compose-input-content" id="compose-content"
                                    placeholder="Nhập nội dung tin nhắn..." rows="5"
                        ...
                        <div class="fb-thread-view" id="fb-page-thread-view" aria-label="Cuộc trò chuyện">
                            <button class="fb-thread-back" type="button" aria-label="Quay lại danh sách">
                                ...
                                <div class="fb-thread-header-avatar fb-avatar is-user" aria-hidden="true">U</div>
                                <div class="fb-thread-back-info">
                                    <div class="fb-thread-back-name">Người dùng</div>
                            ...
                            <div class="fb-reply-area">
                                <div class="fb-reply-wrap">
                                    <textarea class="fb-reply-input" id="fb-page-reply-input"
                                        placeholder="Nhập tin nhắn trả lời..." rows="1"
...
<?php layout("footer", ["js" => ["pages/sidebar", "pages/admin/dashboard", "pages/user/feedback"]]); ?>
